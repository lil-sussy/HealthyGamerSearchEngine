...
const HeroHeader = ({ idToken }: { idToken: string }) => {
  ...
  return (
    <div className="hero-container centering flex flex-col items-center w-full box-border">
      <div className="content-container container !pt-40 flex backdrop-blur-2xl flex-col md:flex-row justify-center gap-16 items-start rounded-2xl">
        <div className="image-container relative pt-20">
          {loading ? (
            <img className="w-40" src="./drkThinking.png" alt="Loading" />
          ) : (
        ...
        <div className="main-content flex flex-col items-start w-40 md:w-[30rem] gap-10">
          ...
          <div className="search-section flex flex-col items-start gap-6">
            <div className="search-form-container flex flex-col items-start gap-2">
              <h4 className="text-lg font-light text-green-500 opacity-80">
                Describe how you feel using one or multiple sentences :
              </h4>
